...
struct Crc16IbmSdlc : public CrcEngine<16, 0x1021, CrcDir::LsbFirst> {
...
struct Crc16IsoIec144433A : public CrcEngine<16, 0x1021, CrcDir::LsbFirst> {
...
struct Crc16OpensafetyB : public CrcEngine<16, 0x755b, CrcDir::MsbFirst> {
...
struct Crc16Profibus : public CrcEngine<16, 0x1dcf, CrcDir::MsbFirst> {
...
struct Crc16Riello : public CrcEngine<16, 0x1021, CrcDir::LsbFirst> {
  static constexpr CrcType Check = 0x63d0;
  static constexpr const char* Name = "CRC-16/RIELLO";
  Crc16Riello() : CrcEngine{0xb2aa, 0x0000} { }
};

struct Crc16SpiFujitsu : public CrcEngine<16, 0x1021, CrcDir::MsbFirst> {
...
struct Crc16T10Dif : public CrcEngine<16, 0x8bb7, CrcDir::MsbFirst> {
  static constexpr CrcType Check = 0xd0db;
  static constexpr const char* Name = "CRC-16/T10-DIF";
  Crc16T10Dif() : CrcEngine{0x0000, 0x0000} { }
};

struct Crc16Teledisk : public CrcEngine<16, 0xa097, CrcDir::MsbFirst> {
...
struct Crc16Tms37157 : public CrcEngine<16, 0x1021, CrcDir::LsbFirst> {
...
struct Crc24Ble : public CrcEngine<24, 0x00065b, CrcDir::LsbFirst> {
  static constexpr CrcType Check = 0xc25a56;
  static constexpr const char* Name = "CRC-24/BLE";
  Crc24Ble() : CrcEngine{0x555555, 0x000000} { }
};

struct Crc24FlexrayA : public CrcEngine<24, 0x5d6dcb, CrcDir::MsbFirst> {
...
struct Crc24FlexrayB : public CrcEngine<24, 0x5d6dcb, CrcDir::MsbFirst> {
...
struct Crc24Interlaken : public CrcEngine<24, 0x328b63, CrcDir::MsbFirst> {
...
struct Crc24LteA : public CrcEngine<24, 0x864cfb, CrcDir::MsbFirst> {
...
struct Crc24LteB : public CrcEngine<24, 0x800063, CrcDir::MsbFirst> {
...
struct Crc24Openpgp : public CrcEngine<24, 0x864cfb, CrcDir::MsbFirst> {
...
struct Crc24Os9 : public CrcEngine<24, 0x800063, CrcDir::MsbFirst> {
  static constexpr CrcType Check = 0x200fa5;
  static constexpr const char* Name = "CRC-24/OS-9";
  Crc24Os9() : CrcEngine{0xffffff, 0xffffff} { }
};

struct Crc30Cdma : public CrcEngine<30, 0x2030b9c7, CrcDir::MsbFirst> {
...
struct Crc31Philips : public CrcEngine<31, 0x04c11db7, CrcDir::MsbFirst> {
...
struct Crc32Aixm : public CrcEngine<32, 0x814141ab, CrcDir::MsbFirst> {
...
struct Crc32Autosar : public CrcEngine<32, 0xf4acfb13, CrcDir::LsbFirst> {
...
struct Crc32Base91D : public CrcEngine<32, 0xa833982b, CrcDir::LsbFirst> {
...
struct Crc32Bzip2 : public CrcEngine<32, 0x04c11db7, CrcDir::MsbFirst> {
...
struct Crc32CdRomEdc : public CrcEngine<32, 0x8001801b, CrcDir::LsbFirst> {
...
struct Crc32Cksum : public CrcEngine<32, 0x04c11db7, CrcDir::MsbFirst> {
...
struct Crc32Iscsi : public CrcEngine<32, 0x1edc6f41, CrcDir::LsbFirst> {
...
struct Crc32IsoHdlc : public CrcEngine<32, 0x04c11db7, CrcDir::LsbFirst> {
...
struct Crc32Jamcrc : public CrcEngine<32, 0x04c11db7, CrcDir::LsbFirst> {
...
struct Crc32Mef : public CrcEngine<32, 0x741b8cd7, CrcDir::LsbFirst> {
...
struct Crc32Mpeg2 : public CrcEngine<32, 0x04c11db7, CrcDir::MsbFirst> {
...
struct Crc32Xfer : public CrcEngine<32, 0x000000af, CrcDir::MsbFirst> {
...
struct Crc40Gsm : public CrcEngine<40, 0x0004820009, CrcDir::MsbFirst> {
...
struct Crc64Ecma182 : public CrcEngine<64, 0x42f0e1eba9ea3693, CrcDir::MsbFirst> {
...
struct Crc64GoIso : public CrcEngine<64, 0x000000000000001b, CrcDir::LsbFirst> {
...
struct Crc64Ms : public CrcEngine<64, 0x259c84cba6426349, CrcDir::LsbFirst> {
...
struct Crc64Nvme : public CrcEngine<64, 0xad93d23594c93659, CrcDir::LsbFirst> {
...
struct Crc64Redis : public CrcEngine<64, 0xad93d23594c935a9, CrcDir::LsbFirst> {
...
struct Crc64We : public CrcEngine<64, 0x42f0e1eba9ea3693, CrcDir::MsbFirst> {
...
struct Crc64Xz : public CrcEngine<64, 0x42f0e1eba9ea3693, CrcDir::LsbFirst> {
...
#if 0
struct Crc82Darc : public CrcEngine<82, 0x0308c0111011401440411, CrcDir::LsbFirst> {
